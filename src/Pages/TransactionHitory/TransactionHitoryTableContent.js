                        ...
                        <div className="px-1 accordion-details">
                            {SectorList && SectorList.map((item, index) => {
                                return <div className="filter-checkbox" key={index}>
                                        <input class="styled-checkbox-primary" type="checkbox" name="sector_value styled-checkbox-primary" id={item.label} value={item.value} onChange={sectorChange} /> 
                                        <label className="text-small" for={item.label}>{item.label}</label>
                                </div>;
                            })}                            
                        </div>                        
                    </Accordion>
                    <Accordion>
                        ...
                        <div className="px-1 accordion-details">
                            {SeriesOfFundingList && SeriesOfFundingList.map((item, index) => {
                                return <div className="filter-checkbox" key={index}>
                                    <input class="styled-checkbox-primary" type="checkbox" name="company_series_of_funding" id={item.label} value={item.value} onChange={fundingChange} /> 
                                    <label className="text-small" for={item.label}>{item.label}</label>
                                </div>;
                            })}
                        </div>                       
