                        ...
                        />
                        {
                          ...
                          virtualAccountDetails.map((holding, index) => (<>
                            ...
                            < TableRow key={index} >
                              ...
                              <TableCell>
                                {isload ? (
                                  <><div > {holding.txn_date != undefined ? holding.txn_date.slice(0, 11) : null} </div>
                                    <div style={{ fontSize: "12px" }}> {holding.txn_date != undefined ? holding.txn_date.slice(11, 17) : null}</div>
                                  </>
                                ) : (
                                  <Skeleton width={100} />
                                )}
                              ...
                              <TableCell>
                                {isload ? (
                                  <>
                                    ...
                                    <div style={{ fontWeight: "600" }}>₹ {holding.amount} </div>
