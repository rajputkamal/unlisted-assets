          ...
          <div className="addcompanyrequest px-4 py-5">
            <div className="addcompanyrequest_container">
              <div className="text-center">
                <h5><b>Dear Client</b></h5>
                <p className="m-0 text-small">Are you sure you want to cancel the offer? <br/> If you cancel, you will have to re-start <br/>the entire process from Marketplace!!</p>
              </div>        
              <div className="addcompanyrequest_buttonContainer text-center mt-4">
                ...
                <Buttons.PrimaryButton value="Confirm" onClick={props.onConfirm} style={{ width: "50%", margin: "0px 5px" }} />
              </div>
            </div>
          </div>
        </Dialog>
