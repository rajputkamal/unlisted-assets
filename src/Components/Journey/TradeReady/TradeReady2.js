          ...
          <div>
            ...
            <div>
              <div className="d-flex align-items-center justify-content-center mobile-display">
                <img src={BotIcon} />
                <p className='m-0 text-small-profile ml-3'> <b className='text-small-profile'>
                “You will need to verify your PAN details. We make sure that <br /> your information is safely processed” <span className="text-primary-color"> Read More </span></b></p>
