                ...
                <div className="profile-first-sec w-100">
                    <div className="d-flex align-items-center justify-content-center">
                        <div className="w-75 text-center">
                            <img src={BotIcon}/>
                            <p className="text-small"><span>“Hi. I am Purple , <br/>
                            Let’s get your journey of unlisted stocks started” </span></p>
...

                {
                    profilecompleted ?
                        <Step key={"label"}  onClick={handleClick2} >
                            <StepLabel StepIconComponent={ColorlibStepIcon} className="cursor-pointer">{"Email"}
                        ...
                        :
                        <Step key={"label"}  onClick={handleClick2}>
                            <StepLabel StepIconComponent={ColorlibStepIcon}>{"Email"}
                            </StepLabel>
                        </Step>
                }
                        ...
                        <Box >
                            ...
                            <Portal container={container.current}>
                                <div className="d-flex align-items-center justify-content-center ">
                                    ...
                                    Your Mobile number has been verified.” </b></p>
                                </div>
                            </Portal>
                            ) : null}
                        </Box>
                         ...
                         <Box >
                            ...
                            <Portal container={container.current}>
                                <div className="d-flex align-items-center justify-content-between ">
                                    <img src={BotIcon} width="50"/>
                                    <p className='m-0 text-small-profile ml-1 text-left'> <b className='text-small-profile'>You will need to fill in your Mobile details. We make sure that your information is safely processed</b></p>
                                        <Link to="/profilewig/mobile_vrification">
                                            <Buttons.SecondaryButton  value="Lets Verify Your Mobile" />
                                        </Link>
                                </div>
                            </Portal>
                            ) : null}
                    ...
                    profilecompleted ?
                        ...
                        <Box >
                            ...
                            <Portal container={container.current}>
                                <div className="d-flex align-items-center justify-content-center ">
                                    <img src={BotIcon} width="50"/>
                                    <p className='m-0 text-small-profile ml-1 text-left'> <b className='text-small-profile'>“Congratulations, your profile is completed. <br />
                                    Your Email has been verified." </b></p>
                                </div>
                            </Portal>
                            ) : null}
                        </Box>
                        ...
                        <>
                         <Box >
                            ...
                            <Portal container={container.current}>
                                <div className="d-flex align-items-center justify-content-between ">
                                    <img src={BotIcon} width="50"/>
                                    <p className='m-0 text-small-profile ml-1 text-left'> <b className='text-small-profile'>You will need to fill in your Personal details. We make sure that your information is safely processed</b></p>
                                        <Link to="/profilewig">
                                            <Buttons.SecondaryButton  value="Lets Complete Your Profile" />
                                        </Link>
                                </div>
                            </Portal>
                            ) : null}
