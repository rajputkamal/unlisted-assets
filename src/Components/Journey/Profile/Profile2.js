          ...
          <div>
            ...
            <div>
              <div className="d-flex align-items-center justify-content-center mobile-display">
                <img src={BotIcon} />
                <p className='m-0 text-small-profile ml-3 text-left'> <b className='text-small-profile'>“You will need to fill in your bank details. We make sure <br /> that your information is safely processed” <span className="text-primary-color"> Read More </span></b></p>
