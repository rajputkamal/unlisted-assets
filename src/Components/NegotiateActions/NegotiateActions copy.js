           ...
           { show ? (<>
                           ...
                           <div className="col-md-3 col-12">
                               <div className="form-group">
                                   ...
                                   onChange={(e)=>{
                                       ...
                                       let txnAmount1 = e.target.value * price
                           ...
                           <div className="col-md-3 col-12">
                               <div className="form-group">
                                   ...
                                   onChange={(e)=> {
                                       ...
                                       settxnAmount(e.target.value * quantity)

                                       let txnAmount1 = e.target.value * quantity

                                       let total1 = (e.target.value * quantity)
                                       + (.01*txnAmount1)+(.18*(.01*txnAmount1))
                       ...
                       <div className="d-flex justify-content-between">
                           <label className="m-0 text-size">Transaction Fees*                          
                            <Tooltip title={<>
                                ...
                                <p className="mb-0">GST (18% of TXN Amount) = {((txnAmount/100)*.18).toFixed(2)}</p>
                                <p className="mb-0">Total = {txnFee.toFixed(2)}</p></>}
                                placement="right" arrow enterTouchDelay={0}>
                                <ErrorOutlineRoundedIcon className="marketplace-infoicon"/>
                            </Tooltip>                                                                             
                        </label><span className="text-size">₹ {txnFee.toFixed(2)}</span>
                       </div>
                       <div className="my-0 text-size2">
                           <label className="mb-0 ">Including GST <Tooltip title={<p className="mb-0">GST<br/> (18% of TXN Amount) = {(txnAmount/100)*.18}</p>}
                            placement="right" arrow enterTouchDelay={0}>
                            <ErrorOutlineRoundedIcon className="marketplace-infoicon"/>
                        </Tooltip></label>
                       </div>
                   ...
                   <div className="row d-flex justify-content-between align-items-center mt-2 create-offer-card-btns">
                       ...
                       <div className="col-lg-6 col-md-12 col-6 d-flex w-100 justify-content-end">
                           ...
                           <Buttons.SecondaryButton value="Cancel" style={{marginRight:"5px",width:"100%"}} onClick={handleOffer}/>
