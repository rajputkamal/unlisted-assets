...
let SellerCard = (props) => {
    ...
    return (
        <div className={props.values.communicationStatus != "accepted" ?"seller-card seller-card-timeout": "seller_card_rejected"}>
            <div className="seller-card-timeout-overlay">
                <p>Your Offer Is Timed Out .</p>
            </div>
