...
let BuyerCard = (props) => {
  ...
  const handleBuyercard = (newPlacement) => (event) => {
    ...
    return (
        ...
        <div className={props.values.communicationStatus != "accepted" ? "buyer-card" : "buyer_card_accepted"} >
            {props.isTradeOwner == false ?
            ...
            <div className="buyer-card-desc mt-1 d-flex justify-content-between">
            ...
            {/*<div className="buyer-card-desc  d-flex justify-content-between">*/}
            {/*    <p className="text-small m-0">Transaction Fees Discount<br/><span style={{fontSize:"10px"}}>*Including GST</span></p>*/}
            {/*    <p className="price m-0">₹ {props.values.buyerFinalTransactionFeeDiscount} </p>*/}
            {/*</div>*/}
            <div className="Buyercard_horizontal_line"> </div>
            <div className="buyer-card-desc d-flex justify-content-between">
                <p className="buyer-proposed_amt m-0 text-small">Total Proposed Amount</p>
                <p className="buyer-proposed-amt-in-numbers m-0 text-small">₹ {txnTotal.toFixed(2)} </p>
            </div>
            <div className="buyer-card-desc d-flex justify-content-between">
                <p className="buyer-user-comment ">*User Comment</p>
                <p className="buyer-user-message text-small">{props.values.message}</p>
            </div>
