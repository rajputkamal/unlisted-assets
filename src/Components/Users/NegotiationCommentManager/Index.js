...
export default function InventoryTableContent(props) {
    ...
    const getAllInventoryget = async function () {
        let response1 = await apiCall("negotiationComments", 'GET', '', history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
        //console.log(responseJSON1._embedded.negotiationComments)
        setRowUser(responseJSON1._embedded.negotiationComments)
        setLoad(true);
    }

    const getAllInventoryupdate = async function (id) {
        let response1 = await apiCall("negotiationComments/" + editedData.id, 'PUT', editedData, history)
        // console.log(response1)
        let responseJSON1 = await response1.json();
    ...
    const getAllInventorydelete = async function (id) {
        let response1 = await apiCall("negotiationComments/" + editedData.id, 'DELETE', '', history)
        // console.log(response1)
        let responseJSON1 = await response1.json();
        // console.log(responseJSON1)
    ...
    const getAllInventoryadd = async function () {
        let response1 = await apiCall("negotiationComments", 'POST', editedData, history)
        // console.log(response1)
        let responseJSON1 = await response1.json();
        // console.log(responseJSON1)
                    ...
                    <div className='col-md-8 col-12'>
                        <div className="Table_title">
                            <div className="d-flex align-items-center justify-content-start w-100">
                                <h5 className='main-heading'><b>Negotiation Comment Manager</b></h5>
                            </div>
                        </div>
                        ...
                        <div className="modal-body">
                            <form className="w-100">
                                ...
                                <div className="form-group mb-1">
                                    <label htmlFor="Type" className="text-small mt-2 mb-1">Type</label>
