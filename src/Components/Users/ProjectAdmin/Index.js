        ...
        <div>
            ...
            <div>
                ...
                <Buttons.PrimaryButton value="upload" onClick={(e) => {
                    onFileUpload(e, "admincontroller/uploadmoduleexcel");
                } } />
            </div>
            {fileData()}
            ...
            <div>
                <a href={downloadurl("admincontroller/downloadmoduleexcel")} download >
                    click to download </a>
            </div>
            ...
            <div>
                ...
                <Buttons.PrimaryButton value="upload" onClick={(e) => {
                    onFileUpload(e, "admincontroller/uploadfeatureexcel");
                } } />
            </div>
            {fileData()}
            ...
            <div>
                <a href={downloadurl("admincontroller/downloadfeatureexcel")} download >
                    click to download </a>
            </div>
