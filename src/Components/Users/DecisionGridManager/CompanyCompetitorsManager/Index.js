...
export default function InventoryTableContent(props){
    ...
    const getAllInventoryget = async function (){
        let response1 = await apiCall12("decisionGridOnboardings/search/findByDecisionGridId?id="+props.company.id,'GET', '', history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
        //console.log(responseJSON1._embedded.decisionGridOnboardings)
        setRowUser(responseJSON1._embedded.decisionGridOnboardings)
    }

    const getAllInventoryupdate = async function (id){
        let response1 = await apiCall("decisionGridOnboardings/"+editedData.id,'PUT', editedData, history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
    ...
    const getAllInventorydelete = async function (id){
        let response1 = await apiCall("decisionGridOnboardings/"+editedData.id,'DELETE', '', history)
        //console.log(response1)
        // let responseJSON1 = await response1.json();
    ...
    const getAllInventoryadd = async function (){
        ...
        let response1 = await apiCall("decisionGridOnboardings",'POST', editedData, history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
        //console.log(responseJSON1)
                                ...
                                (user,index) => (
                                  <TableRow  key={index} id={user.id}>
                                    ...
                                    <TableCell>{ isload ? <> {user.description} </> : <Skeleton width={100} /> }</TableCell>
                                      ...
                                      <TableCell>{ isload ? <> {user.isResidentStatusVerified+""} </> : <Skeleton width={100} /> }</TableCell>
                                      <TableCell>{ isload ? <> {user.isPanNumberVerified+""} </> : <Skeleton width={100} /> }</TableCell>
                                      <TableCell>{ isload ? <> {user.isAAdharNumberVerified+""} </> : <Skeleton width={100} /> }</TableCell>
                                      <TableCell>{ isload ? <> {user.isAddressVerified+""} </> : <Skeleton width={100} /> }</TableCell>


                                      <TableCell>{ isload ? <> {user.isBankVerified+""} </> : <Skeleton width={100} /> }</TableCell>
                                      <TableCell>{ isload ? <> {user.isBusinessNameVerified+""} </> : <Skeleton width={100} /> }</TableCell>
                                      <TableCell>{ isload ? <> {user.isEmailVerified+""} </> : <Skeleton width={100} /> }</TableCell>
                                      <TableCell>{ isload ? <> {user.isMobileVerified+""} </> : <Skeleton width={100} /> }</TableCell>
