  ...
  return(
    <TableHead>
      ...
      <TableCell key="Company Name">
        ...
        <TableCell key="companyDetailsUpdatedStatus">
            <TableSortLabel
                className="Trade_Header_Name"
                style={{fontWeight: "500",fontSize: "14px",color: "#721B65"}}
                IconComponent={TableArrowfunction}
                ...
                onClick={createSortHandler("Mobile Number")}
            >
                companyDetailsUpdatedStatus
            </TableSortLabel>
        </TableCell>

          <TableCell key="companyDetailsUpdatedTimeStamp">
              <TableSortLabel
                  className="Trade_Header_Name"
                  style={{fontWeight: "500",fontSize: "14px",color: "#721B65"}}
                  IconComponent={TableArrowfunction}
                  ...
                  onClick={createSortHandler("Mobile Number")}
              >
                  companyDetailsUpdatedTimeStamp
              </TableSortLabel>
          </TableCell>
          ...
          <TableCell key="howManyTimesJSONDownloaded">
              <TableSortLabel
                  className="Trade_Header_Name"
                  style={{fontWeight: "500",fontSize: "14px",color: "#721B65"}}
                  IconComponent={TableArrowfunction}
                  ...
                  onClick={createSortHandler("Mobile Number")}
              >
                  howManyTimesJSONDownloadedFromInstaServers
              </TableSortLabel>
          </TableCell>
