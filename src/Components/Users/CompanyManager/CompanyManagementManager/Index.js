...
export default function InventoryTableContent(props){
    ...
    const getAllInventoryget = async function (){
        let response1 = await apiCall12("companyManagements/search/findByCompanyId?id="+props.company.id,'GET', '', history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
        //console.log(responseJSON1._embedded.companyManagements)
        setRowUser(responseJSON1._embedded.companyManagements)
    }

    const getAllInventoryupdate = async function (id){
        let response1 = await apiCall("companyManagements/"+editedData.id,'PUT', editedData, history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
    ...
    const getAllInventorydelete = async function (id){
        let response1 = await apiCall("companyManagements/"+editedData.id,'DELETE', '', history)
        //console.log(response1)
        // let responseJSON1 = await response1.json();
    ...
    const getAllInventoryadd = async function (){
        ...
        let response1 = await apiCall("companyManagements",'POST', editedData, history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
        //console.log(responseJSON1)
                                ...
                                (user,index) => (
                                  <TableRow  key={index} id={user.id}>
                                    ...
                                    <TableCell>{ isload ? <> {props.company.cin} </> : <Skeleton width={100} /> }</TableCell>
                                      ...
                                      <TableCell>{ isload ? <> {user.din} </> : <Skeleton width={100} /> }</TableCell>
                                      <TableCell>{ isload ? <> {user.noOfDirectorShips} </> : <Skeleton width={100} /> }</TableCell>
                                     <TableCell >
                        ...
                        <div className={classes.paper}>
                            ...
                            <div className="modal-body">
                                <form className="w-100">
                                    ...
                                    <div className="form-control-row">
                                        <label className="m-0 mt-2 text-small">DIN -</label>
                                        <input type="text" value={editedData.din} onChange={(e) => handleChange("din", e.target.value)}
                                               className="form-control" />
                                    </div>
                                    <div className="form-control-row">
                                        <label className="m-0 mt-2 text-small">noOfDirectorShips -</label>
                                        <input type="text" value={editedData.noOfDirectorShips} onChange={(e) => handleChange("noOfDirectorShips", e.target.value)}
                                               className="form-control" />
                                    </div>
