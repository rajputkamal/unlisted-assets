...
export default function AppDragDropDemo (props) {
    ...
    const [rowuserrolesInformation,setrowuserrolesInformation]=React.useState([]);
    const [rowallrolesInformation,setrowallrolesInformation]=React.useState([]);
    ...
    let onDrop = async (ev, cat) => {
       ...
       if(cat == "userroles") {
           deletoradd = "admincontroller/updaterolepermission/true/"+userid+"/"+id
       } else if(cat == "allroles") {
           deletoradd = "admincontroller/updaterolepermission/false/"+userid+"/"+id
       }
        ...
        let response33 = await apiCall("admincontroller/rolepermission/"+userid,'GET')
        let responseJSON33 = await response33.json();
        await setrowuserrolesInformation(responseJSON33);
        //setrowallrolesInformation(responseJSON33.filter(record=> responseJSON33.indexOf(record.id) == -1))
              ...
              <div className="row">
                <div className="col-md-6 pl-0">
                  <div className="wip my-card ScrollStyle scroll-default"
                      ...
                      <b><span className="task-header">Permission not yet Assigned to the Selected Role</span></b>
                    <table className="w-100 table table-bordered table-hover">
                      ...
                      <tbody>
                      {
                          rowallrolesInformation.map(
                              (role, index) => (             <tr className="text-small">
                                      <td key={"id"}
                ...
                <div className="col-md-6 pr-0">
                  <div className="droppable my-card ScrollStyle scroll-default"
                      ...
                      <b><span className="task-header">Permissions Assigned to the Selected Role</span></b>
