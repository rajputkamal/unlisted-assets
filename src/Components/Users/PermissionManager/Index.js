...
export default function InventoryTableContent(props) {
    ...
    const getSearchOption = async function () {
        let response1 = await apiCall("company/allpermissionsnames", 'GET', '', history)
    ...
    const getAllInventoryget = async function () {
        let response1 = await apiCall("permissions/search/findByNameContaining?searchKey=" + searchkey, 'GET', '', history)
        //console.log(response1)
        setLoad(false);

        let responseJSON1 = await response1.json();
        //console.log(responseJSON1._embedded.permissions)
        setRowUser(responseJSON1._embedded.permissions)
        setLoad(true);
    }

    const getAllInventoryupdate = async function (id) {
        let response1 = await apiCall("permissions/" + editedData.id, 'PUT', editedData, history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
    ...
    const getAllInventorydelete = async function (id) {
        let response1 = await apiCall("permissions/" + editedData.id, 'DELETE', '', history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
        //console.log(responseJSON1)
    ...
    const getAllInventoryadd = async function () {
        let response1 = await apiCall("permissions", 'POST', editedData, history)
        //console.log(response1)
        let responseJSON1 = await response1.json();
        //console.log(responseJSON1)
            ...
            <div className="dbmn">
                <div className="Table_title">
                    <div className="d-flex align-items-center justify-content-start w-100">
                        <h5 className='main-heading'><b>Permission Manager</b></h5>
                    </div>
                </div>
