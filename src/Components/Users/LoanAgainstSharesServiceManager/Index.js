...
// search bar code end here
    ...
    const getAllInventoryget = async function (){
        let response1 = await apiCall("loanAgainstShareses",'GET', '', history)
        // // console.log(response1)
        let responseJSON1 = await response1.json();
        // // console.log(responseJSON1._embedded.roles)
        setRowUser(responseJSON1._embedded.loanAgainstShareses)
        setLoad(true);
    }
      ...
      <div className="user_table_section">
        ...
        <div className="Table_title">
            <div className="d-flex align-items-center justify-content-start w-100">
                <h5 className='main-heading'><b>Loan Against Shares Service Manager</b></h5>
            </div>
        </div>
